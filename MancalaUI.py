...
def main_menu():
    ...
    while intro:
        ...
        TextSurf, TextRect = text_objects("Welcome to Mancala", largeText)
...
def UpdateScreen():
            ...
            count14 = ReturnImageForScore(game.ReturnHoleValue(14))
            count13 = ReturnImageForScore(game.ReturnHoleValue(13))
            ...
            #top row 14-8
            screen.blit(count14, (227,275)) # 237x167
            screen.blit(count13, (284,275)) # 294x167
            screen.blit(count12, (341,275)) # 351x167
            screen.blit(count11, (398,275)) # 455x167
            screen.blit(count10, (455,275)) # 512x167
            screen.blit(count9, (512,275)) # 569x167
            screen.blit(count8, (569,275)) # 569x167
            # bottom row 1-7
            screen.blit(count1, (227,342)) #237x234
            screen.blit(count2, (284,342)) #294x234
            screen.blit(count3, (341,342)) #351x234
            screen.blit(count4, (398,342)) #455x234
            screen.blit(count5, (455,342)) #521x234
            screen.blit(count6, (512,342)) #569x234
            screen.blit(count7, (569,342)) #569x234
            ...
            hole14 = ReturnStoneImage(game.ReturnHoleValue(14))
            hole13 = ReturnStoneImage(game.ReturnHoleValue(13))
            ...
            #top row 12-7
            screen.blit(hole14, (227,110)) # 237x167
            screen.blit(hole13, (284,110)) # 294x167
            screen.blit(hole12, (341,110)) # 351x167
            screen.blit(hole11, (398,110)) # 455x167
            screen.blit(hole10, (455,110)) # 512x167
            screen.blit(hole9, (512,110)) # 569x167
            screen.blit(hole8, (569,110)) # 626x167
            # bottom row 1-6
            screen.blit(hole1, (227,177)) #237x234
            screen.blit(hole2, (284,177)) #294x234
            screen.blit(hole3, (341,177)) #351x234
            screen.blit(hole4, (398,177)) #455x234
            screen.blit(hole5, (455,177)) #521x234
            screen.blit(hole6, (512,177)) #569x234
            screen.blit(hole7, (569,177)) #626x234
